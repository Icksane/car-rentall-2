    ...
    <div className='container mx-auto'>
      ...
      <motion.p
       ...
       className='max-w-[680px] text-center mx-auto mb-2'>
        ...
        the competition. From the moment you engage wwith us, we strive to
    ...
    >
      ...
      xl:max-w-none p-2 xl:p-0'>
        ...
        <p className='hidden xl:flex'>
          We prioritize your need and we above and beyond to ensure your
